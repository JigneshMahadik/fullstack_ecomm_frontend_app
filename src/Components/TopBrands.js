...
export function TopBrands() {
    ...
    async function fetchData() {
        await getTopBrandList(val);
        await getCartedProductList();
        await getWishlistProduct();
    }

    async function getTopBrandList(val) {
        const resp = await axios.get(`https://fullstack-ecomm-backend-app.onrender.com/getTopBrandList?pageNo=${pageNo}&&category=${val}`);
